...
public class Tags extends Plugin {
    ...
    public void start(Context context) {
        ...
        var Token = new ApplicationCommandOption(ApplicationCommandType.STRING, "token", "Token Account",
            null, true, true, null, null);
        ...
        subcommands.add(new ApplicationCommandOption(
            ...
            false,
            null,
            Arrays.asList(Token, CommandsAPI.requiredMessageOption)
        ));
        ...
        commands.registerCommand(
            ...
            ctx -> {
                ...
                if (ctx.containsArg("login")) return Login.execute(ctx.getSubCommandArgs("Token"), settings, this);
