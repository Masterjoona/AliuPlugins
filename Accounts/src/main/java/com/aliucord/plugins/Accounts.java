...
public class Accounts extends Plugin {
    ...
    public void start(Context context) {
        ...
        var accountName = new ApplicationCommandOption(ApplicationCommandType.STRING, "name", "Token name",
            null, true, true, null, null);
        var existingAccount = new ApplicationCommandOption(ApplicationCommandType.STRING, "name", "Token name",
            null, true, true, existingAccounts, null);
        var AccountToken = new ApplicationCommandOption(ApplicationCommandType.STRING, "AccountToken", "Login into an account with a Token",
            null, true, true, null, null);
        subcommands.add(new ApplicationCommandOption(
            ...
            false,
            null,
            Arrays.asList(accountName, CommandsAPI.requiredMessageOption)
        ));
        subcommands.add(new ApplicationCommandOption(
            ApplicationCommandType.SUBCOMMAND,
            "delete",
            ...
            false,
            null,
            Collections.singletonList(existingAccount)
        ));
        subcommands.add(new ApplicationCommandOption(
            ApplicationCommandType.SUBCOMMAND,
            "list",
        ...
        subcommands.add(new ApplicationCommandOption(
            ...
            false,
            null,
            Arrays.asList(existingAccount, CommandsAPI.requiredMessageOption)
        ));
        subcommands.add(new ApplicationCommandOption(
            ApplicationCommandType.SUBCOMMAND,
            "login",
            ...
            ctx -> {
                ...
                if (accounts != null) for (Map.Entry<String, String> account : accounts.entrySet()) {
                    if (ctx.containsArg(account.getKey()))
                        ...
                        return new CommandsAPI.CommandResult("Close Aliucord and remove from recents, and you should be logged in.", null, false);
                }
    ...
    public List<CommandChoice> existingAccounts;
    ...
    public void registerAccount(String name, String message) {
        ...
        existingAccounts.add(Utils.createCommandChoice(name, name));
        subcommands.add(new ApplicationCommandOption(
            ApplicationCommandType.SUBCOMMAND,
            name,
