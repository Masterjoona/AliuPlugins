...
subprojects {
    ...
    aliucord {
        author("Masterjoona", 297410829589020673)

        updateUrl.set("https://raw.githubusercontent.com/Masterjoona/AliuPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/Masterjoona/AliuPlugins/builds/%s.zip")
    }
